...
\input{01-related_works.tex}
\section{Experimental results}
\input{03-experimental_results.tex}
...
convolutional networks,stride, and dilation of the convolutional networks. In this work, we wanted to have the minimum
intervention that would not modify the number of weights of the models as we manipulated the receptive field of the
models. Additionally, in our experiments, as we changed the receptive field, also the size of the feature maps was
...
\input{09-supplementary_material.tex}
  \end{document}
