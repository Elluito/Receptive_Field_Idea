...
\label{tab:cifar10  largeRF one shot pruning rate 09}
\end{table}
\todo[inline]{Here I'm planning to include results of a ResNet24 model that has all the same components as ReseNet50 but
it simply is more shallow. Also I'm running experiments on width for two more receptive fields, 318 and 1415. Also I
haven implementation/showed the information measure we talked about with Netta but as Netta suggested it can be simply
